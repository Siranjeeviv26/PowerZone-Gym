            ...
            >
              <Link to="/membership">
                ...
                >
                  ...
                  {/* Badge circle */}
                  <div className="relative w-36 h-36 rounded-full bg-[#0f1535] border-4 border-yellow-400/80 shadow-2xl shadow-yellow-400/20 flex flex-col items-center justify-center group-hover:scale-110 transition-transform duration-300 overflow-hidden">
                    ...
                    {/* megaphone icon */}
                    <FaBullhorn className="text-white text-xl mb-1 drop-shadow" />

                    {/* SPECIAL text */}
                    <span className="text-white text-[11px] font-black tracking-[0.2em] uppercase leading-none">
                      SPECIAL
                    </span>

                    {/* OFFER text */}
                    <span className="text-yellow-400 text-lg font-black tracking-wider uppercase leading-none mt-0.5 drop-shadow-sm">
                      OFFER
                    </span>

                    {/* offer title */}
                    <span className="text-white/70 text-[9px] font-semibold mt-1 px-2 text-center leading-tight line-clamp-2">
                      {offer.title}
                    </span>
                  </div>
                </motion.div>
